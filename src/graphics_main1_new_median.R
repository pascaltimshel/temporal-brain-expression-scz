############### SYNAPSIS ###################
# Name: graphics_main1_new_median.R
...
p <- p + geom_line(data=df.gilman.summary.sem, aes(x=stage, y=mean1, group=1, color="Gilman et al. clusters I & II"), linetype='solid', size=1) 
