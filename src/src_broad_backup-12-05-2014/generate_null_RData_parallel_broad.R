...
#data_Rdata_result <- "null_RData_broad_rnaseq_associated_priority.RData" # [associated or prioritized][priority or ish]
data_Rdata_result <- "null_RData_broad_rnaseq_prioritized_priority.RData" # prioritized

### Microarray
#file.RData <- "RData/data_marray_expression.RData"
#data_Rdata_result <- "null_RData_broad_marray_associated_priority.RData" # [associated or prioritized][priority or ish]
#data_Rdata_result <- "null_RData_broad_marray_prioritized_priority.RData" # prioritized
...
list.par_analysis <- foreach (i=foreach_min:foreach_max, .packages=c("plyr")) %dopar% {
  ...
  list.null.fits = list(fit.natal=fit.natal, fit.prioritized.higher=fit.prioritized.higher, list.fit.stage=list.fit.stage)
